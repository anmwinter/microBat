...
# rep.set.tree are at
setwd("~/Desktop/bat_fungal/")

###These need to be the names of your files generated in QIIME 1.8
biom_file = "fixed.biom"    ###This is your .biom file
map_file = "mapping.txt"      ###This is your mapping file with all the metadata
...
phylo.ord <- ordinate(phylo, "NMDS", "bray", trymax=30)
...
plot_ordination(phylo, ordu, color = "PLACE") +
